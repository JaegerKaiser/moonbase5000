...
\
		...
		// array versions
		void setUniform(const GLchar* uniformName, const glm::vec4 *v, int count);
		void setUniform(const GLchar* uniformName, const glm::vec3 *v, int count);
		void setUniform(const GLchar* uniformName, const GLfloat *v, int count);
