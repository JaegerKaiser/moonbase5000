...
void Program::setUniform(const GLchar* uniformName, const glm::vec3 *v, int count) {
	setUniform3v(uniformName, glm::value_ptr(*v), count);
}
...
void Program::setUniform(const GLchar* uniformName, const glm::vec4 *v, int count) {
	setUniform3v(uniformName, glm::value_ptr(*v), count);
}

void Program::setUniform(const GLchar* uniformName, const GLfloat *v, int count) {
	setUniform1v(uniformName, v, count);
}
